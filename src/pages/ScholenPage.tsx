...
import type { SchoolListRow, SchoolEditForm } from "@/lib/queryShapes";
          ...
          {(() => {
            ...
            return (
              <div className="space-y-4">
                ...
                {groups.map((g, gi) => (
                  <div key={gi} className="rounded-lg border border-warning-border bg-warning-muted p-3 space-y-2">
